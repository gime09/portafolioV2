...
{fecha: '2024/En proceso', title: 'Tecnicatura Universitaria en Programación', descripcion: 'UTN Facultad Regional San Rafael', enlace:'https://www.frsr.utn.edu.ar/'},
  ...
  {fecha: 'Año de Inicio/Fin:2024 ', title: 'Testing de Webservice con SOAP UI', title: 'Curso de Testing de Webservice con SOAP UI impartido por EducacionIT', enlace:'https://www.educacionit.com/perfil/gimena-gauna-776771/certificado/68414'},
  ...
  {fecha: 'Año de Inicio/Fin:2023 ', title: 'Desarrollador Java Full Stack.', descripcion: 'Curso de Programación y Desarrollo de una aplicación, concluyendo el trayecto formativo Desarrollador Java Full Stack en la Universidad de la Punta en el marco de Argentina Programa 4.0. Horas Cátedras 480.', enlace:'https://www.linkedin.com/in/gimena-gauna-08925a197/details/education/1635550784569/single-media-viewer/?profileId=ACoAAC4iIOkBXpdu1isbvf_r-mqKKLitGhBHng4'},
  {fecha: 'Año de Inicio/Fin:2023 ', title: 'Testing QA (Manual) ', descripcion: 'Curso de Testing QA de 100 horas impartido por EducacionIT en el marco formativo de telecom digitalers', enlace:'https://www.linkedin.com/in/gimena-gauna-08925a197/details/education/1635550891995/single-media-viewer/?profileId=ACoAAC4iIOkBXpdu1isbvf_r-mqKKLitGhBHng4'},
  {fecha: 'Año de Inicio/Fin:2023 ', title: 'Introducción a Devops. ', descripcion: 'Curso de Introducción a Devops impartido por EducacionIT', enlace:'https://www.educacionit.com/perfil/gimena-gauna-776771/certificado/68714'},
  {fecha: 'Año de Inicio/Fin:2023 ', title: 'Java para Principiantes', descripcion: 'Curso de Java para Principiantes Impartido por TodoCode', enlace:'https://todocodeacademy.com/certificate/yyk/'},
