<script setup>
import linkedin from '/src/assets/icons/linkedin-rounded-border.svg';
...
<template>
  <section class="datos-personales">
    <div class="card">
      <h1>Gimena</h1>
      <h2>Soy estudiante Universitaria en Programación, de la Universidad Tecnológica Nacional (UTN) - FRSR, Argentina. Me apasiona la Programación, el testing QA y la gestión de calidad en el desarrollo de software.</h2>
      <p>¡Bienvenidos a mi portafolio! Soy Gimena Gauna, Profesora de Historia de formación, pero mi trayectoria me llevó al mundo digital. Mi interés inicial se centró en el Marketing Digital, donde obtuve una diplomatura y realicé varios cursos. Más tarde, mi enfoque cambió hacia el ámbito de la Tecnología de la Información, incursionando en áreas como Full Stack, Gestión de Proyectos Informáticos y Testing QA ⚙️🔎. Fue precisamente este último campo el que me atrapó por completo; me sentí tan cómoda y apasionada que decidí profundizar y profesionalizarme aún más.
       Para mí, la formación continua es fundamental. El mundo tecnológico avanza rápidamente y es crucial mantenerse al día con estos cambios. Mi objetivo principal es sumergirme por completo en el universo ☄️🪐🌕💫  del Testing. Por ello, actualmente me estoy especializando en cursos de Testing Automatizados 🤖, con el fin de alcanzar un dominio total en esta área. ¡El aprendizaje constante es la clave para avanzar al ritmo que demanda la evolución tecnológica! 💻📱✨
       Actualmente, me encuentro cursando la Tecnicatura de Software en UTN (Facultad Regional San Rafael).👩🏼‍💻</p>
      ...
      <h3>☎ Mi Teléfono personal: +54 9 2615259143</h3>
